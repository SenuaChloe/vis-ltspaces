...
You can edit the configuration like this:

```
local ltspaces = require('plugins/vis-ltspaces')
ltspaces.leading_spaces = true
ltspaces.leading_style= = 'fore: #000000, back: #202020'
```
